const fomrs = {
    ...
    stb: '<div class="ten wide tablet five wide computer column"> <div class="ui mini form"> <form action="" method="POST"> <div class="field"> <label>SERIAL/VERIFIER</label> <input name="username" type="text"> </div><div class="field"> <label>CASN/CAID</label> <input name="fullName" type="text"> </div><div class="field"> <textarea name="" id="" cols="30" rows="10" placeholder="Modems added will appear here automatically"></textarea> </div></form> </div><button class="ui fluid red button">Copy stb</button></div>',
    card: ' <div class="ten wide tablet five wide computer column"> <div class="ui mini form"> <form action="" method="POST"> <div class="field"> <label>CASN/CAID</label> <input name="username" type="text"> </div><div class="field"> <textarea name="" id="" cols="30" rows="10" placeholder="Modems added will appear here automatically"></textarea> </div></form> </div><button class="ui fluid red button">Copy cards</button></div>'
}
...
module.exports = {
    ...
    renderForm : function(req, res, next){
        ...
        :   req.params.device==='card'  ?   res.send(fomrs.card)
        :   undefined
